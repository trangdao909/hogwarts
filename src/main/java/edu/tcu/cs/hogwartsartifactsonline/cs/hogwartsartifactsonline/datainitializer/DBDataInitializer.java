package edu.tcu.cs.hogwartsartifactsonline.cs.hogwartsartifactsonline.datainitializer;
...
// Bootstrap data
@Component // telling Spring responsible create this bean, and its instance
